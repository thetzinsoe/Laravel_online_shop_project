        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-lg-10 offset-1">
                    <div class="mb-4">
                        <a href="{{ route('admin#accountDetail') }}"><i class="fa fa-arrow-left"></i>back</a>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <form action="{{ route('admin#accountUpdate') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-4 d-flex align-items-center">
                                        <div class="">
                                            ...
                                            @else
                                                <img src="{{ asset('admin/images/no_image_found.jpg') }}" class=""
                                                    alt="user photo">
                                            @endif
